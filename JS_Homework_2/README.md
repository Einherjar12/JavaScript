# Домашняя работа №2 по JavaScript
...
6. Написать конвертор валют.  
   Пользователь вводит количество USD и выбирает валюту: EUR, UAN или AZN.
...
10. Запросить дату (день, месяц, год) и вывести следующую за ней дату.  
    Учесть переход на следующий месяц, год и високосный год.
